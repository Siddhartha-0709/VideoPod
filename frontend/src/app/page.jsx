    ...
    <>
      ...
      <div className="pb-36 w-full flex md:justify-center bg-black antialiased bg-grid-white/[0.02] relative overflow-hidden">
        <Spotlight className='-top-40 left-0 md:left-60 md:-top-20'
          fill="white"
        />
        <div className="text-5xl w-screen font-bold text-white mt-44 px-10 ">
          Reimagine
          <FlipWords className='inline-block mb-2 ml-1' words={words} />
          ...
          <p className='text-base text-slate-300 font-light mt-3 w-6/12'>Combines cutting-edge AI with intuitive tools to simplify your video workflows. Extract key moments, generate accurate transcripts, convert to MP3, or customize edits—all in one seamless platform designed to save you time and effort.</p>
          <div>
      ...
      <div className='bg-black py-12 justify-center px-10'>
        <center className='px-10'>
          <FlipWords className='text-4xl font-bold text-white text-center' words={words2} />
        </center>
